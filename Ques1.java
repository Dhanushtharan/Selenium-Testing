...
public class Ques1 {
    public static void main( String[] args ) throws InterruptedException
    {
        ...
        driver.get("https://www.amazon.in/Amazfit-Stratos-A1619-Multisport-Smartwatch/dp/B07BTKVG7S/ref=sr_1_2?qid=1683196286&s=computers&sr=1-2&srs=12516989031");
        driver.manage().window().maximize();
        String title = driver.getTitle();
        String etitle = "Amazfit Stratos A1619 Multisport Smartwatch (Black) : Amazon.in: Computers & Accessories";
        ...
        driver.get("https://www.amazon.in/Huami-Amazfit-Smart-Watch-Desert/dp/B07XTSH7JX/ref=sr_1_1?qid=1683196286&s=computers&sr=1-1&srs=12516989031");
        driver.findElement(By.xpath("//*[@id=\"add-to-cart-button\"]")).click();
        Thread.sleep(2000);
        driver.get("https://www.amazon.in/gp/cart/view.html/ref=dp_atch_dss_cart?");
        Thread.sleep(5000);
